...
<link href="assets/css/custom_member_term.css" rel="stylesheet">
      ...
      <div class="content-half">
        ...
        <div class="right">
          <div class="subtitle" data-plugin="scroll-view">
            <h3><span>會員條款<i class="date" data-term-name="行動夥伴使用條款">2018/03/28</i></span></h3>
          </div>
          <div class="term-text" data-plugin="scroll-view">
            <p>行動夥伴網提供使用者其針對推廣銷售「行動補習網」課程所得獎金的查詢以及請領服務。所有申請成為「夥伴會員」的使用者，都應該詳細閱讀下列使用條款。使用者完成會員註冊手續，即視為已知悉、並完全遵守下列使用條款的所有約定。</p>
          ...
          <ul class="reset term-list" data-plugin="scroll-view">
            <!-- 依程式調整項目錨點名稱 (id) -->
            <li id="term_1">
              <a href="#term_1" class="term-q" title="名詞定義">名詞定義</a>
              <div class="term-a">
            ...
            <li id="term_2">
              <a href="#term_2" class="term-q" title="行動夥伴合作模式及限制">行動夥伴合作模式及限制</a>
              <div class="term-a">
            ...
            <li id="term_3">
              <a href="#term_3" class="term-q" title="推廣獎金計算方式">推廣獎金計算方式</a>
              <div class="term-a">
                <p>獎金計算標的：<br>
            ...
            <li id="term_4">
              <a href="#term_4" class="term-q" title="夥伴會員">夥伴會員</a>
              <div class="term-a">
            ...
            <li id="term_5">
              <a href="#term_5" class="term-q" title="推廣注意事項與懲處規範">推廣注意事項與懲處規範</a>
              <div class="term-a">
            ...
            <li id="term_6">
              <a href="#term_6" class="term-q" title="服務暫停即終止">服務暫停即終止</a>
              <div class="term-a">
            ...
            <li id="term_6">
              <a href="#term_6" class="term-q" title="使用條款之適用與修正與免責聲明">使用條款之適用與修正與免責聲明</a>
              <div class="term-a">
            ...
            <li id="term_7">
              <a href="#term_7" class="term-q" title="準據法及管轄權">準據法及管轄權</a>
              <div class="term-a">
  ...
  $(document).ready(function(e) {
    ...
    $('[data-plugin="scroll-view"]').scrollView({
      ...
      onAddClass: function(element) {
        if($(this).is('.term-list')){
          $('.term-list').find('li').each(function(i,ele){
            setTimeout(function(){
              $(ele).addClass('shown');
            },i*100);
          });
    ...
    // TERM ACCORDION
    // 錨點Hash在URL最末端才會生效
    var $term_list = $('.term-list');
    var hash =  window.location.hash;
    $term_list.find('li').filter('.current').removeClass('current');
    $term_list.find('li').find('.term-a').hide();

    refresh_hash(hash);
    
    function refresh_hash(_targethash){
      $(_targethash).addClass('current');
      $(_targethash).siblings('li').find('.term-a').slideUp(300);
      $(_targethash).find('.term-a').slideDown(300,function(){
        $('html, body').animate({
          scrollTop: $(this).parent().offset().top - $('.header').height() - $(_targethash).siblings('li').filter('.current').height()
        },600);
        $(this).parent().siblings('li').filter('.current').removeClass('current');
        $(window).trigger('resize.px.parallax');
      });
    }

    $term_list.find('.term-q').on('click',function(){
      hash = $(this).attr('href');
      refresh_hash(hash);
    });
