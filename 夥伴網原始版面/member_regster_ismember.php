...
<link href="assets/css/custom_member_register_ismember.css" rel="stylesheet">
    ...
    <div class="container-1400 container clearfix">
      ...
      <div class="content">
        <div class="inner-content" data-plugin="scroll-view">
          <h3 class="subtitle"><span>您在「行動夥伴網」與「行動補習網」</span><span>將共用同一組帳號、密碼</span></h3>
          <form action="member_register_vertify_mobile.php" name="form_register">
            <div class="form-box">
              <span class="label-style"><i class="star">*</i>帳號</span>
              <input type="text" name="account" class="input-style" placeholder="請輸入您在「行動補習網」的帳號 (手機號碼或Email)">
            </div>

            <div class="form-box fogetpwd">
              <span class="label-style"><i class="star">*</i>密碼</span>
              <input type="password" name="pwd" class="input-style" placeholder="請輸入您在「行動補習網」的密碼">
              <a href="ismember_forget.php" class="link-forgetpwd" title="忘記密碼" data-plugin="popup">忘記密碼</a>
            </div>
